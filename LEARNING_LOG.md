...
### 2026-04-20 | Day 0 | Setup
- **Action**: Created Github repo structure for Cv journey
- **Mindset**: Getting things ready and committing to the journey.
- **Tomorrow**: Start Day 1 - Dusty Phillips Ch 1 

### 2026-04-21 | Day 1 | Python 3 OOP - Chapter 1
...
- **Mindset**: Focusing on understanding OOP basics clearly.
...
- **Sections covered**:
  ...
  - Inheritance
- **Duration**: 7pm – 9:00pm
- **Mindset**: Going back and strengthening what I learned.
...
- **Sections covered**:
  ...
  - Started building the Image-Toolkit project with object-oriented analysis and design
- **Duration**: 9pm – 11pm, 11.40pm – 12.10am
- **Mindset**: Starting to apply ideas in a real project.
- **Next will cover**: Continue Image-Toolkit OOA/OOD and revise Chapter 1 concepts

### 2026-04-24 | Day 5 | Python 3 OOP - Chapter 1
...
- **Sections covered**:
  - Reviewed Chapter 1 case study and exercise workflow
  - Added UML design flow for Image-Toolkit project
  - Refined class design, sequence flows, activity diagram, and component/package architecture
- **Duration**: 9am – 12:10pm
- **Mindset**: Improving and organizing my design thinking.
...
- **Mindset**: Making sure the core concepts really stick.
- **Next will cover**: Chapter 2: Topic- Creating python class


### 2026-04-27 | Day 7 | Python 3 OOP - Chapter 2
